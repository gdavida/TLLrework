...
AgeGroup.create!(age:"0 - 3 months")
AgeGroup.create!(age:"3 - 6 months")
AgeGroup.create!(age:"7 -12 months")
AgeGroup.create!(age:"1 year")
AgeGroup.create!(age:"2 years")
AgeGroup.create!(age:"3 - 5 years")
